...
class SAEFeatureAnalyzer:
    ...
    #same as above just copy-pasted and quickly mod'd for lowest
    def find_lowest_activating_examples(self, feature_idx, texts, top_n=20, batch_size=16, window_size=10):
        ...
        print(f"Scanning for feature {feature_idx} to find top {top_n} LOWEST activating examples (batch size {batch_size}, window size {window_size})...")
